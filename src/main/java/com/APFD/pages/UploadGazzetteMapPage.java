...
public class UploadGazzetteMapPage {
	...
	WebDriverWait wait=new WebDriverWait(APFDFrameworkDriverManager.getDriver(), Duration.ofSeconds(10));
	...
	@FindBy(xpath="//a[text()='Upload Data']")
	...
	@FindBy(xpath="//input[@name='blockOthers']")
    ...
    public void uploadGazetteData() throws InterruptedException {
        ...
        if (getBlock().getText().equalsIgnoreCase("Others")) {
            // Locate the others field and interact with it
